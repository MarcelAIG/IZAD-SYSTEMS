...
export function MarketingProductPage() {
  const stats = [
    {
      value: "98%",
      label: "open rate for SMS marketing campaigns."
    },
    {
      value: "5x",
      label: "cheaper to retain an existing customer than acquire a new one."
    },
    {
      value: "10m",
      label: "to launch a campaign that generates thousands."
    }
  ];
  ...
  const features = [
    {
      ...
      description: "Use our library of proven campaigns designed for local businesses.",
      icon: Megaphone
    },
    {
      title: "Audience Segmentation",
      description: "Send offers only to specific groups of past customers.",
      icon: Target
    },
    {
      title: "SMS & Email Blasts",
      description: "Reach your audience exactly where they are paying attention.",
      icon: Mail
    },
    {
      title: "ROI Tracking",
      description: "See exactly how much revenue each campaign generated.",
      icon: BarChart
    }
  ];
  ...
  return (
    <div className="pt-32 pb-12 min-h-screen flex flex-col">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full mb-24 text-center">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tighter text-white font-display mb-6 leading-tight max-w-4xl mx-auto">
            Reactivate Your Past <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-400 to-brand-600">Customers</span>
          </h1>
          <p className="text-xl md:text-2xl text-slate-400 font-medium mb-10 max-w-2xl mx-auto leading-relaxed">
            Stay top of mind and instantly generate revenue with proven, one-click text and email campaigns.
          </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full mb-32">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-extrabold text-white font-display mb-6">Effortless Growth</h2>
          <p className="text-xl text-slate-400 max-w-2xl mx-auto">Generate revenue on demand with powerful campaigns.</p>
        </motion.div>
